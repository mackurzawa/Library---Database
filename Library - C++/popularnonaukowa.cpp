...
popularnonaukowa::popularnonaukowa(bool czy_pytac)
    :ksiazka(czy_pytac)
{
    if(czy_pytac)
    {
...
std::string popularnonaukowa::return_autor()
{
    return autor;
}

void popularnonaukowa::change_autor(std::string nowy_autor)
{
    autor = nowy_autor;
}

std::string popularnonaukowa::return_tytul()
{
    return tytul;
}

void popularnonaukowa::change_tytul(std::string nowy_tytul)
{
    tytul = nowy_tytul;
}

void popularnonaukowa::showDetails()
{
    std::cout<<std::endl;
...
void popularnonaukowa::modifyObject()
{
    std::string temp;
    std::cout<<std::endl;
...
void popularnonaukowa::readFile(std::ifstream& rfile)
{
